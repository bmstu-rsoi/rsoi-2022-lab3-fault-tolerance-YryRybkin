...
public class CreateReservationServiceResponse {
    ...
    public CreateReservationServiceResponse(UUID reservationUid, UUID hotelUid, Date startDate, Date endDate, String status, UUID paymentUid, Integer price) {
    ...
    public boolean equals(Object o) {
        ...
        CreateReservationServiceResponse that = (CreateReservationServiceResponse) o;
