...
public class ReservationServiceResponse {
    ...
    public ReservationServiceResponse(UUID reservationUid, HotelInfo hotel, Date startDate, Date endDate, String status, UUID paymentUid) {
    ...
    public boolean equals(Object o) {
        ...
        ReservationServiceResponse that = (ReservationServiceResponse) o;
